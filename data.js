...
// Event: Riya's Engagement · Mumbai · 18 Dec 2026
...
const EVENTRA = {
  ...
  feasibility: {
    ...
    aiInsight: "Your ₹8,00,000 budget for 150 guests in Mumbai is achievable but tight. Venue and catering will consume ~55%. Prioritise a mid-range banquet hall and keep décor minimal. Photography and food quality can be fully protected within this plan.",
    categories: [
      { name:"Venue",       icon:"building-2",  recommended:240000, percent:30, risk:"Medium", explanation:"Mumbai banquet halls for 150 guests range ₹1.8L–₹3L. Budget is tight but workable with the right negotiation." },
      { name:"Catering",    icon:"utensils",    recommended:200000, percent:25, risk:"Low",    explanation:"₹1,333/plate for 150 guests. FeastCraft can deliver within this allocation." },
      ...
      { name:"Photography", icon:"camera",      recommended:80000,  percent:10, risk:"Low",    explanation:"Priority category. Good mid-range photographers available at ₹65–80K in Mumbai." },
  ...
  vendors: {
    photography: [
      {
        ...
        quoteMissing:["GST 18% — ₹11,700","Travel — est. ₹4,000–₹8,000","Album — est. ₹8,000–₹15,000","Drone — est. ₹4,000–₹6,000"],
        ...
        risks:["GST 18% adds ₹11,700 — confirm if included","No album in base package — family may expect one","Travel to Andheri not confirmed"],
        questions:["Is GST of 18% included in your quoted ₹65,000?","Is travel to Royal Orchid Banquet, Andheri included or charged separately?","What is the overtime charge per hour if the event runs beyond 8 hours?"],
      ...
      },
      {
        ...
        whyRecommended:"Lower base price with GST and album included. Saves ₹8,000–₹15,000 on album. However, solo photographer for 150-guest event is a significant risk.",
      ...
      },
      {
        ...
        whyRecommended:"Most comprehensive package but exceeds ₹80,000 photography budget even at base price. Availability unconfirmed after 14 days.",
        ...
        questions:["Are you available for 18 December 2026 at Royal Orchid Banquet, Andheri?","Is travel from Powai to Andheri included?","Can the package be adjusted to fit a ₹80,000 budget?"],
        confidence:"Low", confidenceColor:"red",
    ...
    venue: [
      {
        ...
        location:"Andheri West, Mumbai", image:"🏛️",
        ...
        whyRecommended:"Best price-to-capacity ratio for 150 guests in Andheri. Allows outside caterers (with fee). Basic furniture included reduces décor cost.",
        risks:["Outside vendor fee ₹8,000–₹15,000 if using FeastCraft","GST not mentioned in quote","Security deposit ₹25,000 (refundable — confirm timeline)"],
        questions:["Is GST of 18% included in the ₹1,95,000 quote?","What is the outside caterer fee, and does it apply to FeastCraft Catering?","Is the ₹25,000 security deposit fully refundable and in how many days?"],
        confidence:"Medium", confidenceColor:"amber",
    ...
    catering: [
      {
        ...
        location:"Bandra, Mumbai", image:"🍽️",
        ...
        quoteMissing:["Vendor meals (est. 20 pax) — ₹6,000–₹10,000","Water & beverages — ₹3,000–₹6,000","Transport — ₹2,000–₹4,000","GST 5%"],
        whyRecommended:"Highest Eventra Match Score. Serving staff included, excellent engagement event reviews. Transparent inclusions. Menu matches Riya's elegant style.",
        risks:["Vendor meals for photographer and decorator not included — est. ₹6,000–₹10,000","Extra plates at ₹1,400/head if guest count increases","GST 5% not confirmed in quote"],
        questions:["Are vendor meals for the photographer and decorator team (approx. 15 people) included?","Is transport from your kitchen to the venue included?","Is GST 5% included in the ₹1,85,000 total?"],
    ...
    decoration: [
      {
        id:"d1", name:"Aura Events Décor", category:"Decoration",
        ...
        quoteMissing:["Setup labour — ₹8,000–₹12,000","Teardown — ₹5,000–₹8,000","Transport — ₹3,000–₹5,000"],
        whyRecommended:"Good portfolio for Elegant & Minimal. Responsive and available. Base price ₹15,000 over decoration budget and hidden costs push total further over.",
        risks:["Setup and teardown not included — adds ₹13,000–₹20,000","Total estimated ₹35,000–₹50,000 over ₹80,000 budget"],
        questions:["Is setup labour for installation included in your ₹95,000 quote?","Is teardown and removal of materials included or charged separately?","Is transport from your Malad warehouse to the venue included?"],
        confidence:"Medium", confidenceColor:"amber",
    ...
    categories: [
      {
        ...
        items:[
          { name:"GST 18%",            amount:"₹32,400–₹39,600", risk:"High",   status:"unconfirmed"    },
          { name:"Service charge",      amount:"₹9,000–₹18,000",  risk:"High",   status:"unconfirmed"    },
          { name:"Electricity surcharge",amount:"₹3,000–₹8,000",  risk:"Medium", status:"unconfirmed"    },
          { name:"Outside vendor fee",  amount:"₹5,000–₹15,000",  risk:"High",   status:"unconfirmed"    },
          { name:"Corkage fee",         amount:"₹0–₹5,000",       risk:"Low",    status:"not-applicable" },
          { name:"Security deposit",    amount:"₹25,000",          risk:"Medium", status:"confirmed"      },
        ]
      },
      {
        name:"Catering", icon:"utensils", riskCount:4, rangeMin:12000, rangeMax:22000,
        items:[
          { name:"Vendor meals (20 pax)",amount:"₹6,000–₹10,000", risk:"High",   status:"unconfirmed" },
          { name:"Water & beverages",    amount:"₹3,000–₹6,000",  risk:"Medium", status:"unconfirmed" },
          { name:"Extra plate cost",     amount:"₹800–₹1,400/head",risk:"Medium", status:"unconfirmed" },
          { name:"Service staff",        amount:"₹4,000–₹8,000",  risk:"Medium", status:"confirmed"   },
        ]
      },
      {
        name:"Photography", icon:"camera", riskCount:5, rangeMin:8000, rangeMax:18000,
        items:[
          { name:"GST 18%",         amount:"₹11,700",        risk:"High",   status:"unconfirmed" },
          { name:"Travel & fuel",   amount:"₹4,000–₹8,000",  risk:"High",   status:"unconfirmed" },
          { name:"Printed album",   amount:"₹8,000–₹15,000", risk:"Medium", status:"unconfirmed" },
          { name:"Drone coverage",  amount:"₹4,000–₹6,000",  risk:"Low",    status:"unconfirmed" },
          { name:"Overtime/hr",     amount:"₹3,500/hr",       risk:"Medium", status:"unconfirmed" },
        ]
      },
      {
        name:"Decoration", icon:"sparkles", riskCount:4, rangeMin:7000, rangeMax:12000,
        items:[
          { name:"Setup labour",     amount:"₹8,000–₹12,000", risk:"High",   status:"unconfirmed" },
          { name:"Teardown charges", amount:"₹5,000–₹8,000",  risk:"Medium", status:"unconfirmed" },
          { name:"Transport",        amount:"₹3,000–₹5,000",  risk:"Low",    status:"unconfirmed" },
          { name:"Electricity",      amount:"₹1,500–₹3,000",  risk:"Low",    status:"confirmed"   },
        ]
      },
    ]
  },
  ...
  simulator: {
    ...
    recoveryOptions:[
      ...
      { title:"Switch to Budget Caterer",  saving:30000, action:"Replace FeastCraft with a mid-range caterer at ₹900/plate. Similar menu, slightly reduced presentation.", experienceImpact:"Medium", stars:2, risk:"Medium", riskColor:"amber" },
      ...
      { title:"Use Contingency Budget",    saving:0, usesContingency:71000, contingencyRemaining:9000, action:"Draw ₹71,000 from the reserved contingency. Only ₹9,000 remains as buffer.", experienceImpact:"None", stars:5, risk:"High", riskColor:"red" },
    ]
  },
  ...
  tradeoff: {
    ...
    allPriorities:["Food Quality","Venue","Décor","Photography","Entertainment","Convenience","Guest Experience"],
    scenarios:[
      {
        title:"Minimal Décor Approach", chip:"Saves Most", saving:55000, resultingTotal:810000,
        changes:[
        ...
        guestNote:"Guests will notice simpler décor but food quality, photography, and the overall atmosphere remain excellent.",
        withinBudget:false
      },
      {
        title:"Venue Swap: Sahara Star", chip:"Balanced", saving:134400, resultingTotal:730600,
        changes:[
          { category:"Venue",     change:"Switch from JW Marriott to Sahara Star (₹2500/plate)",  saving:134400 },
  ...
  questions: {
    ...
    Decoration:[
      ...
      "Are electricity charges for lighting and electrical décor included?",
      "Is furniture rental included or separate?",
      "What happens if specific floral items are unavailable on the event date?",
      "Is the décor fully customisable to our Elegant & Minimal preference?",
  ...
  dashboard: {
    ...
    nextBestDecision:{
      ...
      description:"Ask whether the outside vendor fee (₹8,000–₹15,000) applies to FeastCraft Catering before paying the ₹50,000 advance. This one question could save or cost ₹15,000.",
    ...
    payments:[
      ...
      { vendor:"Aura Events Décor",    amount:47500,  type:"Advance (50%)",  dueDate:"1 Oct 2026",   status:"pending" },
  ...
  painPoints:[
    { id:"PP-01", priority:"must",      title:"True final event cost is unclear",       description:"Users budget ₹10–12L for 200 guests but have no way to verify if that's realistic for their city and requirements.",                          icon:"calculator"           },
    ...
    { id:"PP-05", priority:"must",      title:"Generic filters give misleading matches",description:"'Starting at ₹40,000' becomes ₹74,000 after travel, overtime, album, drone, and GST are added.",                                               icon:"filter-x"             },
    ...
    { id:"PP-18", priority:"must",      title:"Trust in AI recommendations",            description:"Black-box 'here's your vendor' won't earn a ₹5-lakh decision. Users need to see the reasoning behind every recommendation.",                  icon:"shield-check"         },
  ...
  metrics:{
    ...
    supporting:[
      ...
      "Average estimated overspend prevented per user (₹)",
  ...
  vendorProfiles: [
    { id: "v1", type: "Hotel", name: "JW Marriott Juhu", location: "Juhu, Mumbai", rating: 4.8, reviews: 450, startingPrice: 3200, priceUnit: "per plate", capacity: "100-1000 pax", tags: ["Luxury", "Beachfront", "Premium Catering"], image: "🏨", description: "Iconic luxury beachfront hotel offering grand ballrooms, world-class culinary experiences, and breathtaking sunset views over the Arabian Sea." },
    { id: "v2", type: "Hotel", name: "Sahara Star", location: "Vile Parle East, Mumbai", rating: 4.6, reviews: 320, startingPrice: 2500, priceUnit: "per plate", capacity: "100-1500 pax", tags: ["Indoor Lagoon", "Airport Proximity", "Grand Decor"], image: "🏛️", description: "Architectural masterpiece featuring a tropical lagoon, massive central dome, and ultra-spacious banquet halls perfect for grand Indian weddings." },
    { id: "v3", type: "Hotel", name: "Taj Santacruz", location: "Santacruz, Mumbai", rating: 4.7, reviews: 290, startingPrice: 3250, priceUnit: "per plate", capacity: "100-800 pax", tags: ["Opulent", "Chandelier Ballrooms", "Heritage Brand"], image: "🏰", description: "Blending classic Taj hospitality with modern opulence, offering palatial ballrooms and exceptional bespoke menus." },
    { id: "v4", type: "Farmhouse", name: "Della Resorts (Lawn)", location: "Lonavala (Near Mumbai)", rating: 4.5, reviews: 180, startingPrice: 250000, priceUnit: "per day", capacity: "100-500 pax", tags: ["Destination", "Hill Station", "Luxury Resort"], image: "🏕️", description: "Sprawling luxury adventure resort offering multiple outdoor lawns and indoor banquets for high-end destination weddings." },
    { id: "v5", type: "Photographer", name: "Wedding Nama", location: "Mumbai", rating: 4.9, reviews: 310, startingPrice: 150000, priceUnit: "per day", capacity: "N/A", tags: ["Candid", "Cinematic", "Celebrity Choice"], image: "📸", description: "Premium wedding photography and filmmaking team known for capturing raw emotions and cinematic storytelling." },
    { id: "v6", type: "Decorator", name: "The Wedding Design Co.", location: "Mumbai", rating: 4.8, reviews: 145, startingPrice: 300000, priceUnit: "per event", capacity: "N/A", tags: ["Bespoke Sets", "Floral Art", "Luxury"], image: "🌸", description: "High-end bespoke event styling, creating immersive environments and theatrical floral setups for luxury events." },
  ],

  // ─── Landing Testimonials ───────────────────────────────────
  testimonials:[
    { name:"Priya M.", role:"Bride · Mumbai", quote:"I thought my ₹12L budget was fine. Eventra showed me it was ₹2.4L short before I signed a single contract. Saved me from a nightmare.", avatar:"PM" },
    { name:"Karan S.", role:"Event Host · Bangalore", quote:"The hidden cost detector caught ₹38,000 in charges I would have discovered on billing day. That's not a feature — that's peace of mind.", avatar:"KS" },
    { name:"Ananya R.", role:"Planning a Wedding · Delhi", quote:"I had three photographers at similar prices. Eventra's comparison showed one was ₹22,000 cheaper on true final cost. The choice was obvious.", avatar:"AR" },
  ]
};
